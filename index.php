...
<script href="assets/js/chat.js"></script>
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-col l3 m6 w3-margin-bottom">
        <div class="w3-display-container">
          ...
          <img href="/w3images/house2.jpg" style="width:99%">
        </div>
      </div>
    </div>
    <div class="w3-row-padding">
      <div class="w3-col l3 m6 w3-margin-bottom">
        <div class="w3-display-container">
          ...
          <img href="/w3images/house5.jpg" style="width:99%">
        </div>
      </div>
      <div class="w3-col l3 m6 w3-margin-bottom">
        <div class="w3-display-container">
          <div class="w3-display-topleft w3-black w3-padding">Pipa Support</div>
          <img href="/w3images/house4.jpg" style="width:99%">
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="w3-row-padding w3-grayscale">
          <div class="w3-col l3 m6 w3-margin-bottom">
            <img href="/w3images/team2.jpg" alt="Sumeru" style="width:100%">
